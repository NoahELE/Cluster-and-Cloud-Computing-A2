...
def download_weather(location, code, year, month):
    ...
    if os.path.exists(csv_filename):
        ...
        weather = weather[['Date', 'Minimum temperature (°C)', 'Maximum temperature (°C)', 'Rainfall (mm)', 'Sunshine (hours)', 'Speed of maximum wind gust (km/h)']]
        # Rename the columns
...
station = {'Melbourne (Olympic Park)': '3033',
