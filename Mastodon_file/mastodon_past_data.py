...
last_load_days=0
#Avoid display problems with the update progress bar due to time differences
...
while keep_going:
    ...
    #load_days = (start_date - current_date).days
    #update_load_days = (fix_start_date - current_date).days
